...
"""
Meta_vendas = 50000
Quantidade_vendida = input ("Digite a quantidade vendida: ")

if Quantidade_vendida > str(50000):
    print("Batemos a meta de vendas de Iphone, vendemos {} unidades".format(Quantidade_vendida))
else:
    print('Infelizmente não batemos a meta, vendemos {} unidades. A meta era de {} unidades'.format(Quantidade_vendida, Meta_vendas))
